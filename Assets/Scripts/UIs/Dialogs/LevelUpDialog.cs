...
public class LevelUpDialog : Dialog
{
    ...
    protected override void Init()
    {
        ...
        instant.GetText("StatUpCost").text = $"Ruby {userData.ActorData.Hp * 5}";
        ...
        instant.GetText("StatUpCost").text = $"Ruby {userData.ActorData.MoveSpeed * 5}";
        ...
        instant.GetText("StatUpCost").text = $"Ruby {userData.ActorData.AttackDamage * 5}";
        ...
        instant.GetText("StatUpCost").text = $"Ruby {userData.ActorData.AttackSpeed * 5}";
    ...
    private void UpdateCost(string target = "")
    {
        ...
        switch (target)
        {
            ...
            default:
                ...
                _templates["HP"].GetText("StatUpCost").text = $"Ruby {userData.ActorData.Hp * 5}";
                _templates["MS"].GetText("StatUpCost").text = $"Ruby {userData.ActorData.MoveSpeed * 5}";
                _templates["AD"].GetText("StatUpCost").text = $"Ruby {userData.ActorData.AttackDamage * 5}";
                _templates["AS"].GetText("StatUpCost").text = $"Ruby {userData.ActorData.AttackSpeed * 5}";
                break;
        }
    }
